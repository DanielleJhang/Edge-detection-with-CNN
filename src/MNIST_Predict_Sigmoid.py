...
def Predict_Digit(imvalue):
    ...
    with tf.Session() as sess:
        sess.run(init_op)
        saver.restore(sess, os.path.join(os.path.dirname(__file__), 'Model', 'Model_Sigmoid.ckpt'))
        print ("Model successfully loaded. Current Model = Single-layer Perceptron, Activation: Sigmoid")
